...
import { SentData } from "@/components/Data";

const Sent: React.FC = () => {
  const shouldScroll = SentData.length > 6;
        ...
        {SentData.length !== 0 ? (
          <div className="mt-4">
            ...
            <div className="mt-2 flex flex-col">
              <div
                className={`-my-2 overflow-x-auto -mx-4 sm:-mx-6 lg:-mx-8 pb-10 ${
                  shouldScroll ? "h-[calc(20em+2rem)]" : ""
                }`}
              >
